...
//    }
//
//    @PutMapping("/{emailVendedor}/{cnpj}/{nivel}")
//    public ResponseEntity<Void> atualizar(@PathVariable String emailVendedor, @PathVariable String cnpj, @PathVariable String nivel){
//        EmpresaDescModelo desc = new EmpresaDescModelo();
//        desc.setCnpjd(cnpj);
